		...
		<div class="container" style="width:100%!important">
			<div class="columns has-text-centered">
				<div class="column jumbotron is-12">
					...
					<p>
						<a class="button submit is-medium btn-custom" href="contact.html">
...
<section class="main" style="margin-left: -57px;margin-right: -57px;">
		...
		<div class="container">
			<div class="columns bottom">
				<div class="column copyright has-text-light is-pulled-left">
					<p>
						<?php printf( __( 'Built by %1$s', 'theme_name' ), '<a href="'. esc_url( 'https:webmobapps.com' ) .'">Webmobapps</a> © 2018 All Rights Reserved' ); ?>
					</p>
				</div>
	...
	<section>
		@php(wp_footer()) @endwhile @endsection