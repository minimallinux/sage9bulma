...
// 1. customize CMC path
add_filter('cmc/settings/path', __NAMESPACE__. '\my_cmc_settings_path');
function my_cmc_settings_path( $path ) {
 // update path
 $path = get_stylesheet_directory() . '/cmc/';
 // return
 return $path; 
}
// 2. customize CMC dir
add_filter('cmc/settings/dir', __NAMESPACE__ . '\my_cmc_settings_dir');
function my_cmc_settings_dir( $dir ) {
 // update path
 $dir = get_stylesheet_directory_uri() . '/cmc/';
 // return
 return $dir; 
}
// 4. Include CMC
